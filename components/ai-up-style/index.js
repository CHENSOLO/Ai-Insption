...
Component({
  ...
  data: {
    multiIndex: [0, 0,],
    multiArray: [['时尚', '美妆', '数码', '健身', '旅行与探险', '教育与学习', '家居与装饰', '母婴育儿', '食品与烹饪', '财经与投资'], ['搭配博主','护肤博主','户外探险博主','健身教练博主','旅行攻略博主','学习方法博主','家居设计博主','家庭旅行博主','美食博主']]
    ...
    bindMultiPickerColumnChange(event) {
      ...
      switch (data.multiIndex[0]) {
        ...
        case 8:
          ...
          break;
        case 9:
          data.multiArray[1] = ['美食博主', '投资理财博主', '创业投资博主', '个人理财博主'];
          break;
      }
      // console.log(data);
